...
try {
    ...
    globalThis.config = {
        templatesDir: path_1.default.join(CONFIG_DIR_PATH, (_a = rawConfig.templatesDir) !== null && _a !== void 0 ? _a : './templates'),
        targetDir: path_1.default.join(CONFIG_DIR_PATH, (_b = rawConfig.targetDir) !== null && _b !== void 0 ? _b : './'),
    };
}
catch (e) {
